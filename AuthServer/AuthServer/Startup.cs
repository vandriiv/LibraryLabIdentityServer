...
using AuthServer.Api.Infrastructure.Services;
...
namespace AuthServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LibraryAPIContext>(options => options.UseSqlServer(Configuration["ConnectionStrings:ApiDB"]));
